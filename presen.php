...
<script>
	...
	function abre()
	{
		...
		x=open('WEB/ResultadosxFoliop.php?id='+ document.getElementById('id').value,'' ,'width=500,height=800'); 
		x.close; 
...
<div id="page">
  ...
  <div id="content">
    ...
    <div id="latest-post" class="post">
      ...
      <div id="TabbedPanels1" class="TabbedPanels"><ul class="TabbedPanelsTabGroup"><li class="TabbedPanelsTab Estilo3" tabindex="0">Impresion de Resultados</li>
        ...
        <div class="TabbedPanelsContentGroup">
          ...
          <div class="TabbedPanelsContent">
            ...
            <div class="AccordionPanelContent">
                      <form  target="_self" name="xFolio" method="Get" action="WEB/ResultadosxFoliop.php">
                       <label>
                        <div align="center">
                        ...
                        <div align="center">
                          <input type="button" value="Enviar" onclick="abre()"/>
 ...
 <link rel="STYLESHEET" type="text/css" href="codebase/dhtmlxcalendar.css" />
          ...
          <div class="TabbedPanelsContent">
              ...
              <form  target="_self" name="ver" method="Get" action="ver.php">
              <table>
       ...
       Fecha Inicial: 
          ...
          <img style="cursor:pointer;" onclick="showCalendar(3)" src="WEB/Styles/INFOLAB/Images/DatePicker.gif" align="absmiddle" />               
       ...
       Fecha Final: 
          ...
          <img style="cursor:pointer;" onclick="showCalendar(4)" src="WEB/Styles/INFOLAB/Images/DatePicker.gif" align="absmiddle" />               
          <div style="position:relative; border:0px  width: 50px;width: 100px;">
          <div id="calendar4" style="position:absolute; left:190px; top:-50px; display:none"> </div>
          <tr>   
          ...
          <tr>   
            ...
            <td><input name="Apellidos" id="Apellidos" size="50" value=""></td>
          </tr>
           <tr >
            <td ><label for="Procedencia">Procedencia:</label></td> 
          ...
          <tr >
            <td ><label for="Tipo">Tipo de Paciente:</label></td> 
