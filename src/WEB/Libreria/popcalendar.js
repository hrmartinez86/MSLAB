...
var imgDir = imgDir ? imgDir : 'images/';  // directory for images ... e.g. var imgDir="/img/"
var dayName = '';
    ...
    if (startAt==0) {
        dayName = {
            ...
            dayName = {
                ...
                no : new Array('Man','Tir','Ons','Tor’','Fre','Lør','Søn'),
...
var styleAnchor = 'text-decoration:none;color:black;cursor:default;'; //'text-decoration:none;color:black;';
var styleLightBorder = 'border-style:solid;border-width:1px;border-color:#FF6600;'; //'border:1px solid #a0a0a0;';
