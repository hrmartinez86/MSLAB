...
$sql="SELECT FECHA, HORA, NUMERO, NUMERO_REGISTRO, RUT, USUARIO_CREACION, NOMBRE_USUARIO, ANOS, 
NOMBRE_DOCTOR, FECHATOMAMUESTRA, FECHARECEPCIONMUESTRA, ESTADOTOMAMUESTRA, ESTADORECEPCIONMUESTRA,
 HORARECEPCIONMUESTRA, FECHA_REGISTRO, IDPACIENTE, ORI_PAC, TIPO_DE_URGENCIA, OBSTOMAMUESTRA, DESCRIPCION,
  RUT_PACIENTE, NOMBRE, APELLIDOS, SEXO, TELEFONO, FECHA_NACIMIENTO, PREVISION, CONTRAINDICACIONES, 
  PROCEDENCIA_MUESTRA, FOLIO_HOST, NUM_CAMA FROM SISTEMA_TOMA_MUESTRAS_PACIENTE WHERE (numero = '".$folio."')";
    ...
    <tr>
      <td valign="top">
        ...
        <table height="10" cellpadding="0" cellspacing="0" class="Record">
          ...
          <?php $sql="SELECT     *
FROM         SISTEMA_ATENCION_EXAMENES SAE 
