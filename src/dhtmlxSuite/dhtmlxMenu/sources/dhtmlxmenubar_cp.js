...
dhtmlXContextMenuObject.prototype.correctMenuPosition=function(panel,mode){ 
			...
			var yval = document.body.offsetHeight;
			if(yval == 0 && document.defaultView && document.defaultView.innerHeight)
      				yval = document.defaultView.innerHeight;
			var ys = yval - 15 + document.body.scrollTop;

			if (document.body.parentNode.scrollTop)
				ys=document.body.parentNode.offsetHeight+document.body.parentNode.scrollTop;
