...
<br></br>-->
<br></br>
<form id="Citas" method="post" name="Citas" action="guarda_u.php">
    <table align="center" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td valign="top">
        <table class="Header" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="th"><strong>Usuarios</strong></td> 
          ...
          <tr class="Controls">
            <td class="th"><label for="CitasNombres">Nombre:</label></td> 
            <td><input name="nombre" id="CitasNombres" value="" size="70"></td>
            <td></td>
          </tr>
 
          <tr class="Controls">
            <td class="th"><label for="Password">Password:</label></td> 
            <td><input type="password" name="Password" id="Password" value="" size="70"></td>
            <td></td>
          </tr>
         
          <tr class="Controls">
            <td class="th"><label for="Password2">Confirmar password:</label></td> 
            <td><input type="password" name="Password2" id="Password2" value="" size="70"></td>
            <td></td>
          </tr>
...
<table align="center">
    <tr>
        <td><input value="Guardar" type="button" src="WEB/img/icons/bguardatencion.jpg" onClick="GuardaUsuario()" /></td>
    </tr>
</table>
<p>
  <!-- END Record Citas -->
