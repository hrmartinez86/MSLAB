...
if (isset($_REQUEST["btn_acceso"]))
{
	...
	$MSG_ERROR='<font color="green">Atención : El Usuario o Contraseña no son válidos. Reinténtelo.</font>';
	if ($ERROR == 1)
	{
	...
	else
	{
		...
		include ('ConectaM.php');
		$ERROR = 1;
		$ERROR = Conecta($usuario, $contrasena);
...
<body>
<img src="Imagenes/IngresoMedico.jpg" width="503" height="463" style="position:absolute; left: 11px; top: 15px;" onMouseMove="">
...
<div style="font-size:14px; font:Tahoma; color:#848282; position:absolute; width: 408px; height: 21px; left: 59px; top: 81px;">Ingrese su Nombre de Usuario y Contraseña correspondiente.</div>
<form name="frm_control" method="post" action="IngresoMedico.php" target="_self">
<input name="usuario" type="Text" maxlength="12" size="14px" style="position:absolute; top: 190px; left: 245px; width: 84px; height: 20px;">
<input name="contrasena" type="password" maxlength="12" style="position:absolute; top: 233px; left: 245px; width: 111px; height: 20px;">
