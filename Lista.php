...
<div id="page">
 ...
 <link rel="STYLESHEET" type="text/css" href="codebase/dhtmlxcalendar.css" />
          ...
          <div class="TabbedPanelsContent">
              ...
              <form  target="_self" name="ver" method="Get" action="pdf/listaimp.php">
              <table>
               <link rel="STYLESHEET" type="text/css" href="codebase/dhtmlxcalendar.css" />
               <table id="fecha" >
       Fecha Inicial: 
       ...
       Fecha Final: 
          ...
          <tr >
            <td ><label for="Seccion">Secci&oacute;n:</label></td> 
            <td><select id="Seccion" name="Seccion">
            	<?php
			       echo '<option value="" </option>';
				  $sql="SELECT     lab_relacion_laboratorio_seccion.cod_llave AS Codigo, lab_secciones.descripcion AS Seccion FROM         lab_relacion_laboratorio_seccion INNER JOIN    lab_secciones ON lab_relacion_laboratorio_seccion.seccion = lab_secciones.codigo order by seccion ";
			      $query=odbc_exec($conection,$sql);
			      while ($result=odbc_fetch_array($query))
			          {
			        	echo '<option value="'.$result['Codigo'].'">'.$result['Seccion'].'</option>';
			          }			
		        ?>        
				</select>
            </td>
          ...
          <tr >
           ...
           <td>
           <div align="center">
                          <input href=javascript:window.print("pdf/listaimp.php") type="submit" value="Enviar" />
                          <input type="reset"	value="Borrar" name="B" />
                          <br />
                        </div>
            </td>            
