...
<table border="0" cellspacing="0" cellpadding="0" width="1154">
    ...
    <tr>
           ...
           <td width="1102"> <select id="Secciond" name="Secciond" onchange="javascript:Seccionf.submit()">
            	<?php
            ...
            <td><input type="hidden" name="Seccion" id="Seccioncod" size="50" value="<?php echo $_GET['Secciond'];?>" /></td>
          </tr>
...
<!-- <form name=fl>
<table><tr>
    <td><input id="texto"/></td>
     
    </tr></table>
</form> -->
<td><input type="image" src="imagenes/validar.jpg" width="121" height="27" name="validar" onClick="validarres('<?php ECHO $_GET['Paciente'];?>')"> </td>
...
<TABLE>
    ...
    ?>              <tr><td colspan=6><IMG height=12 src="Imagenes/Transparente.gif" width=20></td></tr>
                    ...
                    <input <?php if($result["ESTADO"]==' ' || $result["ESTADO"]==''||$result["ESTADO"]=='P'){}else{echo "readonly";}?> style="background-color:<?php echo $color;?>;" type="text" name="res2" value="<?php echo ($result["RESULTADO"]); ?>" id="<?php ECHO $llave;?>" onChange="valor('<?php ECHO $llave;?>','<?php ECHO $perfil;?>','<?php ECHO $paciente;?>','<?php ECHO $tipo;?>','<?php ECHO $alto;?>','<?php ECHO $bajo;?>','<?php echo $result["ESTADO"];?>'); javascript: return false;">
