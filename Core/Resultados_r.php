...
<table border="0" cellspacing="0" cellpadding="0" width="1154">
    ...
    <tr>
           ...
           <td> <select id="Folio" name="Folio" onchange="folio()">
            ...
            <td><input type="hidden" name="id" id="id" size="50" value="<?php if ($_GET['id']==""){echo $paciente[0];}else{echo $idpac;};?>"></td>
          </tr>
            <tr>
...
FROM         lab_relacion_laboratorio_seccion INNER JOIN
        ...
        <tr>
           ...
           <tr>
               <td><input type="hidden"  name="id" id="id" size="50" value="<?php if ($idpac==""){echo $paciente[0];}else {echo $idpac;}?>"></td>
...
<td><input type="image" src="imagenes/lapiz.jpg" width="52" height="50" name="Ant" onClick="editar(<?php if ($idpac==""){echo $paciente[0];}else {echo $idpac;}?>)" title="Editar"> </td>
</tr>
</table>
...
<TABLE>
    ...
    ?>
                                <tr> 
                                  ...
                                  <input type="checkbox"  width="12" height="12" name="des" <?php if($result["ESTADO"]=='P'||$result["ESTADO"]==' ' || $result["ESTADO"]=='' || $result["ESTADO"]=='T'){echo "disabled";}?>>
                                  </td> 
<!--                                  <td bgcolor=#5c7ec3 height=25 align=center valign=middle  width="20%"> 
...
<!--                    <td bgcolor=#3759a2 height=25 align=center valign=middle width="20%"> 
                    ...
                    <td bgcolor=#5c7ec3 height=15 align=center valign=middle width="5%">
                   <input type="checkbox"  width="12" height="12" name="des2" <?php if($result["ESTADO"]==' ' || $result["ESTADO"]=='' || $result["ESTADO"]=='T'){echo "disabled";}?>>
                    </td> 
