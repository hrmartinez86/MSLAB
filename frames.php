...
<frameset rows="110px,70%,5%" cols="*" framespacing="0" frameborder="no" border="0">
  ...
  <frame src="cuerpo.php" name="mainFrame" id="mainFrame" title="mainFrame" />
  <frame src="pie.php" name="bottomFrame" scrolling="No" noresize="noresize" id="bottomFrame" title="bottomFrame" />
</frameset>
<noframes>
<body >
</body>
