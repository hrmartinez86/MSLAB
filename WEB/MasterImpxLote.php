...
protected $y0;      // Ordenada de comienzo de la columna
    ...
    function encabezado($nombre,$doctor,$procedencia,$fecha,$numero,$xE){
        ...
        $this->WriteText('Q.F.B. xxxxx xxxxx xxxx xx',$anchoPagina,5,'B',$fontSize,$font,true,false);
        $this->WriteText('Direccion laboratorio',$anchoPagina,5,'',$fontSize,$font,true,false);
