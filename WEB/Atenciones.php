          ...
          <table height="90" cellpadding="0" cellspacing="0" class="Record" width="50">
            ...
            <tr class="Controls">
              ...
              <td style="width:10%">
                ...
                </select> <input required type="hidden"  id="examenes" name="examenes" value="" /><input required type="hidden" name="examenesDescripcion">
              </td>
              <td><input type="text" id="precioTotal" value="0" size="5" >Total</td>
