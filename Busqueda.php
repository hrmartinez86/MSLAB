...
<div id="page">
        ...
        <div class="TabbedPanelsContentGroup">
          ...
          <div class="TabbedPanelsContent">
            ...
            <div class="AccordionPanelContent">
                      <form  target="_self" name="xFolio" method="get" action="Resultados.php">
                       <label>
                        <div align="center">
                          <h1>BUSQUEDA DE PACIENTE POR FOLIO</h1>
                        </div>
                        <div align="center">Desde
                          <input type="text" name="foliod" id="foliod" />
                        </div>
                        <div align="center">Hasta
                          <input type="text" name="folioh" id="folioh" />
                        </div>
                        <div align="center">
 ...
 <link rel="STYLESHEET" type="text/css" href="codebase/dhtmlxcalendar.css" />
          ...
          <div class="TabbedPanelsContent">
              ...
              <form  target="_self" name="Resultados" method="get" action="Resultados.php">
              <table>
