...
//        alert("hola");
	x=open('WEB/ResultadosxFoliop.php?id='+ oGrid.getCellValueString(oGrid.getCellByRow(oGrid.getRowByCell(oCell), 0)) ,'' ,'width=500,height=800'); 
	x.close; 
	//window.open("xFolio.php?folio="+oGrid.getCellValueString(oGrid.getCellByRow(oGrid.getRowByCell(oCell), 0)),"_self","");
	//alert	(" 
	//alert(	"");
}
