...
X = (document.compatMode!="BackCompat"?"X":"");
   if (!this.fullview) {
	   var html = "<div class='cs_Content' csid='cs_Content' style='display:none;'>";
	   	//IE selectbox fix
	   if ((document.all)&&((this.container.currentStyle["position"]=="absolute")))
		   html +="<iframe src='"+(window.dhx_globalImgPath||"")+"blank.html' frameBorder='0' style='position:absolute; top:0px; left:0px; width:244px;  height:"+(this._cc?250:231)+"px; z-index:-1;'></iframe>";
	   ...
	   html += "<tr><td style='width:2px;background:url("+(this.imgURL||"")+"left.gif);'></td><td style='width:"+(document.all?247:243)+"px;height:"+(this._cc?281:240)+"px;background:#E6E5E5;'>";
	   html +="<table class='cs_ContentTable' csid='cs_ContentTable' cellpadding='0px' cellspacing='0px' style='margin:8px;'>";
	   html += "<tr>";
	   ...
	   html += "<tr><td rowspan='2' valign='top' style='text-align:left;'><div class='cs_EndColor_Mini' csid='cs_EndColor' ></div></td><td>Hue:</td><td><input tabindex='1' class='cs_Input_Mini"+X+"' csid='cs_InputHue' value='' /></td><td>Red:</td><td><input tabindex='4' class='cs_Input_Mini"+X+"' csid='cs_InputRed' value='' /></td></tr>";
	   html += "<tr><td>Sat:</td><td><input tabindex='2' class='cs_Input_Mini"+X+"' csid='cs_InputSat' value='' /></td><td>Green:</td><td><input tabindex='4' class='cs_Input_Mini"+X+"' csid='cs_InputGreen' value='' /></td></tr>";
	   html += "<tr><td style='vertical-align:top;width:80px;text-align:left;'># <input csid='cs_Hex' class='cs_Hex_Mini"+X+"'></td><td>Lum:</td><td><input tabindex='2' class='cs_Input_Mini"+X+"' csid='cs_InputLum' value='' /></td><td>Blue:</td><td><input tabindex='4' class='cs_Input_Mini"+X+"' csid='cs_InputBlue' value='' /></td></tr>";   
	
	   if (this._cc){
		html +=	"<tr><td colspan='6'><input tabindex='7' class='cs_CustomColorAdd_Mini' csid='cs_CustomColorAdd' type='button' value='Add to Custom Colors' onClick='this.addCustomColor();'></td></tr>";			     
		html +=	"<tr><td colspan='6'><div class='cs_CustomColors_Mini' csid='cs_CustomColors'></div></td></tr>";
	   }
	   html +=	"</table>";   
	   html += "</td></tr>";
	   html += "</table>";
	   html += "<table cellpadding='0' cellspacing='0' style='width:100%;'><tr><td style='width:100%;height:37px;background:url("+(this.imgURL||"")+"buttons_panel.gif);'><input tabindex='9' class='cs_ButtonCancel' csid='cs_ButtonCancel' type='button' value='Cancel' /><input tabindex='8' class='cs_ButtonOk' csid='cs_ButtonOk' type='button' value='Select' /></td></tr></table>";
	   ...
	   var html = "<div class='cs_Content' csid='cs_Content' style='display:none;'>";
	   	//IE selectbox fix
	   if ((document.all)&&((this.container.currentStyle["position"]=="absolute")))
		   html +="<iframe src='"+(this.imgURL||"")+"blank.html' style='position:absolute; top:0px; left:0px; width:307px;  height:"+(this._cc?450:401)+"px; z-index:-1;'></iframe>";
	   html += "<table cellpadding='0' cellspacing='0'>";
	   html += "<tr><td style='width:2px;height:2px;background:url("+(this.imgURL||"")+"left_top.gif);'></td><td style='height:2px;background:url("+(this.imgURL||"")+"top.gif);'></td><td style='width:2px;height:2px;background:url("+(this.imgURL||"")+"right_top.gif);'></td></tr>";
	   ...
	   html += "<tr><td rowspan='3'><div class='cs_EndColor' csid='cs_EndColor'></div></td><td valign='top' style='text-align:center;width:80px;'># <input csid='cs_Hex' class='cs_Hex'></td><td>Hue:</td><td><input tabindex='1' class='cs_Input' csid='cs_InputHue' value='' /></td><td>Red:</td><td><input tabindex='4' class='cs_Input' csid='cs_InputRed' value='' /></td></tr>";
	   html += "<tr><td></td><td>Sat:</td><td><input tabindex='2' class='cs_Input' csid='cs_InputSat' value='' /></td><td>Green:</td><td><input tabindex='4' class='cs_Input' csid='cs_InputGreen' value='' /></td></tr>";
	   html += "<tr><td></td><td>Lum:</td><td><input tabindex='2' class='cs_Input' csid='cs_InputLum' value='' /></td><td>Blue:</td><td><input tabindex='4' class='cs_Input' csid='cs_InputBlue' value='' /></td></tr>";   
	
	   if (this._cc){
		html +=	"<tr><td>";
		html +=	"<div class='cs_CustomColors' csid='cs_CustomColors'></div>";
		html +=	"</td><td></td><td colspan='4' valign='top'><input tabindex='7' class='cs_CustomColorAdd' csid='cs_CustomColorAdd' type='button' value='Add to Custom Colors' onClick='this.addCustomColor();'></td></tr>";
	   }
	   html +=	"</table>";   
	   html += "</td></tr>";
	   html += "</table>";
	   html += "<table cellpadding='0' cellspacing='0' style='width:100%;'><tr><td style='height:49px;background:url("+(this.imgURL||"")+"buttons_panel.gif);'><input tabindex='9' class='cs_ButtonCancel' csid='cs_ButtonCancel' type='button' value='Cancel' /><input tabindex='8' class='cs_ButtonOk' csid='cs_ButtonOk' type='button' value='Select' /></td></tr></table>";
	   html += "</td><td style='width:2px;background:url("+(this.imgURL||"")+"right.gif);'></td></tr>";
	   html += "<tr><td style='width:2px;height:2px;background:url("+(this.imgURL||"")+"left_bottom.gif);'></td><td style='height:2px;background:url("+(this.imgURL||"")+"bottom.gif);'></td><td style='width:2px;height:2px;background:url("+(this.imgURL||"")+"right_bottom.gif);'></td></tr>";
	   html += "</table>";
	   html +="</div>";	   
...
{
   if (Math.abs(this.old_hue - hue) < 10 && Math.abs((this.old_sat - sat)*100) < 10) {
      return;
   }
   this.old_hue = hue;
   this.old_sat = sat;
...
dhtmlXColorPicker.prototype._selectCustomColor = function(ev)
{
   ...
   var z = this.z;
   if (!this.selected) {
       for (c in z.customColors)
           z.customColors[c].style.border = '1px solid gray';
...
*     @eventparam:  selected color rgdHec
*     @eventparam:  selected color rgdDec
*     @eventparam:  selected color HSL
*/
...
*/
dhtmlXColorPicker.prototype.getSelectedColor = function(func){
...
dhtmlXColorPicker.prototype.linkTo = function(obj1,obj2,obj3){
   ...
   obj2.onclick=function(){
      ...
      if (x>document.body.offsetHeight/2){
         var ck=self.elements['cs_Content'];
         ck.style.visibility="hidden";
         ck.style.display="";
         var y=z[0]+s[1]+obj1.offsetHeight-ck.offsetHeight;
